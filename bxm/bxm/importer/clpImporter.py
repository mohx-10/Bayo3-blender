...
def update_clp_bone_items():
    global bone_items
    bone_items = []
    bone_items.append((str(65535), "None (65535)", ""))
...
class UpdateCLPVisualizer(bpy.types.Operator):
    ...
    def execute(self, context):
        ...
        for clothwk in bpy.context.scene.clp_clothwk:
            ...
            if bone and bone_down and clothwk.no_down != "65535":
            ...
            if clothwk.no_down != "65535" and clothwk.no_poly != "65535":
